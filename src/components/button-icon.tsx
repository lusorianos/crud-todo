...
export default function ButtonIcon({
  ...
  return (
    <button
      className={buttonIconVariants({ className, variant, size, disabled, handling, })}
      {...props}
    >
      <Icon className={buttonIconIconVariants({ size, variant })}  animate={handling} svg={handling ? IconSpinner : icon} />
    </button>
  );
}